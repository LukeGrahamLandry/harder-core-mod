...
public class HelpBook extends WritableBookItem {
    ...
    private ListNBT getPages(){
        ...
        addPage("Your air quality (displayed above food) is reduced by proximity to torches or furnaces and raised by time spent outside. Too low quality causes damage, nausea and blindness.", pages);
